...
class Building():
	...
	"""
	def __init__(self, x_point, y_point, width, height, color, buildings):
	...
	def draw(self):
		Height1=random.choice(height<600 and height>500)
		pygame.draw(screen,x_point, y_point, width, height, color)
