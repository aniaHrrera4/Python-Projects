...
class BouncingBall(): 
    ...
    def flashBounce(self, screen, colors, screen_width, screen_height):
        ...
        pygame.draw.circle(self.screen, self.ball_color, [self.x_location, self.y_location], self.ball_size)
...
while not done:
	...
	ball=bouncingball(self, x_location, y_location, x_speed, y_speed, ball_size)
